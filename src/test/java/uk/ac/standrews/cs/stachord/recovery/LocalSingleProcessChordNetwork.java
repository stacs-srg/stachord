...
public class LocalSingleProcessChordNetwork extends ChordNetwork {

    private final LocalHost localHost;

    public LocalSingleProcessChordNetwork(final int network_size, final KeyDistribution key_distribution) throws IOException {
