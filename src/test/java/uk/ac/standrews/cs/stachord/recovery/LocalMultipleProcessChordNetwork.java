...
public class LocalMultipleProcessChordNetwork extends ChordNetwork {

    private final LocalHost local_host;

    public LocalMultipleProcessChordNetwork(final int network_size, final KeyDistribution key_distribution) throws IOException {
