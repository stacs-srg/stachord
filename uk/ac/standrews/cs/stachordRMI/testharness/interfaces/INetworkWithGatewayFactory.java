...
public interface INetworkWithGatewayFactory<Application> {
	 ...
	 * @throws Exception
	 */
	IChordNetworkWithGateway<Application> makeNetwork(int numNodes) throws Exception;
	 ...
	 * @throws Exception
	 */
	IChordNetworkWithGateway<Application> makeNetwork(String[] keyStrings) throws Exception;
}
