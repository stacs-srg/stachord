...
public interface IP2PNetworkFactory<T> {
	/**
	 ...
	 * @throws Exception
	 */
	IP2PNetwork<T> makeNetworkWithGateway(int numNodes) throws Exception;
	 ...
	 * @throws Exception
	 */
	IP2PNetwork<T> makeNetworkWithGateway(String[] keyStrings) throws Exception;
}
